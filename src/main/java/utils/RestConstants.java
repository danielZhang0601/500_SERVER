...
public class RestConstants {
   ...
   //post param
	...
	public static final String USER_EQU1 = "userequ1";
	public static final String USER_EQU2 = "userequ2";
	public static final String USER_CARD = "usercard";
	public static final String USER_PWD = "userpwd";
	public static final String SOUVENIR_ID = "souid";
	public static final String SOUVENIR_TYPE_ID = "soutypeid";
	public static final String SOUVENIR_TYPE_NAME = "soutypename";
	public static final String SOUVENIR_CODE = "soucode";
	public static final String IMAGE_ID = "imageid";
	public static final String RECORD_ID = "recordid";
	public static final String RECORD_CONTENT = "recordcontent";
	public static final String SOUVENIR_LENGTHS = "lengths";
	public static final String SOUVENIR_WIDES = "wides";
	public static final String SOUVENIR_HIGHS = "highs";
	public static final String SOUVENIR_WEIGTHS = "weights";
